...
def moch_yayan():
    ...
    print'------------------------------------------------------------------'%(N,O,N));time.sleep(2)
    print ' [%s4%s]. Mulai crack                            |'%(O,N);time.sleep(0.03)
    print'------------------------------------------------------------------'%(N,O,N));time.sleep(2)
    print' [%s5%s]. Check ingformasi akun fb    |'%(O,N);time.sleep(0.03)
    print' ------------------------------------------------------------------'%(N,O,N));time.sleep(2)
    ...
    print'_______________________________________|'%(N,O,N));time.sleep(2)
    pepek = raw_input('\n [*] menu : ')
    if pepek == '':
